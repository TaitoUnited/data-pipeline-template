...
# Labels
taito_project=data-pipeline-template
taito_project_short=fstemplate # Max 10 characters
taito_project_nonspecial=${taito_project//-/}
taito_random_name=data-pipeline-template
taito_company=companyname
taito_family=
taito_application=template
taito_suffix=
taito_namespace=data-pipeline-template-$taito_env

# Template reference
template_version=1.0.0
template_name=DATA-PIPELINE-TEMPLATE
